...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        _, ott_name, current_status_num = query.data.split("_")
        current_status_num = int(current_status_num)
        ...
        await query.message.edit_text(ott_message, reply_markup=ott_keyboard)
