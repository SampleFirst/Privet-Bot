...
REFER_ON = is_enabled(environ.get('REFER_ON', "True"), True)
DAILY_BONUS = is_enabled(environ.get('DAILY_BONUS', "True"), True)
WITHDRAW_BTN = is_enabled(environ.get('WITHDRAW_BTN', "True"), True)
